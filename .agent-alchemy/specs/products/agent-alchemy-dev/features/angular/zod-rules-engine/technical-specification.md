...
meta:
id: products-agent-alchemy-dev-features-angular-zod-rules-engine-technical-specification-md
...
# Zod Rules Engine - Technical Specification
...
Zod Rules Engine implements a **infrastructure layer service** following Clean Architecture principles. It provides a centralized, type-safe, and reactive implementation that integrates seamlessly with Angular's dependency injection system.
...
└────────────────┬─────────────────────────┘
                 ...
                 ↓
     ┌───────────────────────┐
     │   Zod Rules Engine Service     │  ← Main service
     └───────────┬───────────┘
                 │
     ┌───────────┴───────────┬────────────┐
     ↓                       ↓            ↓
...
export class ZodRulesEngineService {
  // Service implementation
}

// Or use forRoot() pattern for configuration
@NgModule()
export class ZodRulesEngineModule {
  static forRoot(config: Config): ModuleWithProviders {
    return {
      ngModule: ZodRulesEngineModule,
      providers: [
