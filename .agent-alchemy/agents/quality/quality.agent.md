...
aiContext: true
tools: ['read', 'search', 'edit', 'mcp_github_issue_write']
target: vscode
intents: ['validate-quality', 'create-defects']
keywords: ['quality', 'validation', 'defects', 'testing', 'compliance']
topics: ['quality-assurance', 'validation', 'testing']
mcp-servers: ['github']
handoffs: []
implements_skill: quality
