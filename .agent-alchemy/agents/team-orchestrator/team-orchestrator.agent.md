...
target: vscode
intents: ['orchestrate-team', 'compose-agents']
keywords: ['orchestration', 'meta-agent', 'team-composition', 'workflow']
topics: ['meta-orchestration', 'agent-composition', 'workflow-coordination']
mcp-servers: []
handoffs: ['research', 'plan', 'architecture', 'developer', 'quality', 'content-automation', 'seo-marketing']
implements_skill: team-orchestrator
