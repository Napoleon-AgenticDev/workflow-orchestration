...
aiContext: true
tools: ['read', 'search', 'edit', 'fetch_webpage']
target: vscode
intents: ['create-content', 'content-automation', 'social-media']
keywords: ['content', 'automation', 'social-media', 'marketing', 'seo', 'content-pipeline']
topics: ['content-automation', 'social-media-marketing', 'content-strategy']
mcp-servers: []
handoffs: []
implements_skill: content-automation
