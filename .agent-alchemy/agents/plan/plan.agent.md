...
target: vscode
intents: ['create-plan', 'requirements']
keywords: ['planning', 'requirements', 'business-rules', 'specifications']
topics: ['technical-planning', 'requirements-engineering']
mcp-servers: []
handoffs: []
implements_skill: plan
